...
public class LTDescr
{
	...
	public LTDescr setRotateAround(){
		...
		easeInternal = ()=>{
			...
			var rotateAroundPt = (Vector3)trans.TransformPoint( _optional.point );
	...
	public LTDescr setCanvasAlpha(){
		...
		easeInternal = ()=>{
			...
			if(uiImage!=null){
				...
				var c = rawImage.color; c.a = val; rawImage.color = c;
			}
			if(useRecursion){
	...
	public LTDescr setCanvasMoveX(){
		...
		easeInternal = ()=>{ var c = rectTransform.anchoredPosition3D; rectTransform.anchoredPosition3D = new Vector3(easeMethod().x, c.y, c.z); };
		return this;
	}
	...
	public LTDescr setCanvasMoveY(){
		...
		easeInternal = ()=>{ var c = rectTransform.anchoredPosition3D; rectTransform.anchoredPosition3D = new Vector3(c.x, easeMethod().x, c.z); };
		return this;
	}
	...
	public LTDescr setCanvasMoveZ(){
		...
		easeInternal = ()=>{ var c = rectTransform.anchoredPosition3D; rectTransform.anchoredPosition3D = new Vector3(c.x, c.y, easeMethod().x); };
		return this;
	}
	...
	public LTDescr setGUIMove(){
		...
		easeInternal = ()=>{ var v = easeMethod(); _optional.ltRect.rect = new Rect( v.x, v.y, _optional.ltRect.rect.width, _optional.ltRect.rect.height); };
		return this;
	}
	...
	public LTDescr setGUIMoveMargin(){
		...
		easeInternal = ()=>{ var v = easeMethod(); _optional.ltRect.margin = new Vector2(v.x, v.y); };
		return this;
	}
	...
	public LTDescr setGUIScale(){
		...
		easeInternal = ()=>{ var v = easeMethod(); _optional.ltRect.rect = new Rect( _optional.ltRect.rect.x, _optional.ltRect.rect.y, v.x, v.y); };
		return this;
	}
